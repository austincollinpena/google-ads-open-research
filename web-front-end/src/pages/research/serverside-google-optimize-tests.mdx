...
<Image alt="create a google optimize experiment" src="/experiment-name.png" />

Add a variant

<Image alt="name your Google optimize experiment" src="/add-variant-name.png" />
...
<Image alt="ignore this warning" src="/ignore-warning.png" />
